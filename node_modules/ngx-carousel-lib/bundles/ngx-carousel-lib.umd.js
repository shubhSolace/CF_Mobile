(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-carousel-lib', ['exports', '@angular/core'], factory) :
    (factory((global['ngx-carousel-lib'] = {}),global.ng.core));
    ...
    var SwiperDirective = /** @class */ (function () {
        function SwiperDirective(el, renderer) {
            ...
            this.onSwipeUp = new core.EventEmitter();
            this.onSwipeDown = new core.EventEmitter();
            this.onSwipe = new core.EventEmitter();
        ...
        SwiperDirective.propDecorators = {
            ...
            onSwipeUp: [{ type: core.Output }],
            onSwipeDown: [{ type: core.Output }],
            onSwipe: [{ type: core.Output }],
    ...
    var CarouselComponent = /** @class */ (function () {
        function CarouselComponent(componentElement) {
            ...
            this.onChangeProperties = new core.EventEmitter();
            this.onSlideChange = new core.EventEmitter();
            this.onSlideCentered = new core.EventEmitter();
            this.onTransitionStart = new core.EventEmitter();
            this.onTransitionEnd = new core.EventEmitter();
            this.onSlideNextTransitionStart = new core.EventEmitter();
            this.onSlideNextTransitionEnd = new core.EventEmitter();
            this.onSlidePrevTransitionStart = new core.EventEmitter();
            this.onSlidePrevTransitionEnd = new core.EventEmitter();
            this.onSlideMove = new core.EventEmitter();
            this.onSlideMoveEnd = new core.EventEmitter();
            this.onSlideMoveStart = new core.EventEmitter();
            this.onTouchMove = new core.EventEmitter();
            this.onTouchStart = new core.EventEmitter();
            this.onTouchEnd = new core.EventEmitter();
            this.onReachBeginning = new core.EventEmitter();
        ...
        CarouselComponent.propDecorators = {
            ...
            morePairSlides: [{ type: core.Input }],
            threshold: [{ type: core.Input }],
            angle: [{ type: core.Input }],
            ratioScale: [{ type: core.Input }],
            margin: [{ type: core.Input }],
            perspective: [{ type: core.Input }],
            endInSlide: [{ type: core.Input }],
            timeToSlide: [{ type: core.Input }],
            lockSlides: [{ type: core.Input }],
            initialSlide: [{ type: core.Input }],
            loop: [{ type: core.Input }],
            mode: [{ type: core.Input }],
            autoPlay: [{ type: core.Input }],
            delayAutoPlay: [{ type: core.Input }],
            onInit: [{ type: core.Output }],
            onReady: [{ type: core.Output }],
            onChangeProperties: [{ type: core.Output }],
            onSlideChange: [{ type: core.Output }],
            onSlideCentered: [{ type: core.Output }],
            onTransitionStart: [{ type: core.Output }],
            onTransitionEnd: [{ type: core.Output }],
            onSlideNextTransitionStart: [{ type: core.Output }],
            onSlideNextTransitionEnd: [{ type: core.Output }],
            onSlidePrevTransitionStart: [{ type: core.Output }],
            onSlidePrevTransitionEnd: [{ type: core.Output }],
            onSlideMove: [{ type: core.Output }],
            onSlideMoveEnd: [{ type: core.Output }],
            onSlideMoveStart: [{ type: core.Output }],
            onTouchMove: [{ type: core.Output }],
            onTouchStart: [{ type: core.Output }],
            onTouchEnd: [{ type: core.Output }],
            onReachBeginning: [{ type: core.Output }],
            onReachEnd: [{ type: core.Output }],
            carouselElm: [{ type: core.ViewChild, args: ['carousel',] }],
            containerElm: [{ type: core.ViewChild, args: ['container',] }]
        };
    ...
    ***************************************************************************** */
    ...
    var DomChangeDirective = /** @class */ (function () {
        function DomChangeDirective(elementRef) {
            ...
            this.domChange = new core.EventEmitter();
            /** @type {?} */
        ...
        /** @nocollapse */
        DomChangeDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
        DomChangeDirective.propDecorators = {
            domChange: [{ type: core.Output }]
        };
    ...
    exports.ɵb = DomChangeDirective;
    exports.ɵa = SwiperDirective;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=ngx-carousel-lib.umd.js.map